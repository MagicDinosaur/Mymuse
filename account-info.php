      ...
      <div class="col-lg-4">
        <div class="card mb-4">
          <div class="card-body text-center">
            ...
            <!-- <p class="text-muted mb-1">Full Stack Developer Bay Area, San Francisco, CA</p> -->
            <?php 
...
ini_set('display_errors', '1');
        ...
        <h5> <b onclick=showLastestScoresTable()> Lastest Scores </b> | <b onclick =showHighestScoresTable()> Best Achievement</b></h5>
        <div class="row">
